...
See [`docs/architecture.md`](docs/architecture.md) for the full breakdown: system overview, the trace generation pipeline, the visualizer adapter pattern, mistake classification, and the recommendation logic. It also includes an honest discussion of what the trace-your-own-code system can and can't do.
